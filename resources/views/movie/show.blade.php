    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <p><strong>Estado: </strong>
             ...
             <form action="{{ action('MovieController@peliculaAlquilada', array('movie' => $pelicula)) }}" method="POST" enctype="multipart/form-data">
                {{method_field('PUT')}}
                @csrf
            ...
            {{method_field('DELETE')}}
            @csrf
             <button class="btn btn-danger" type="submit">Borrar pel&iacute;cula</button>
            </form>
        </div>
    </div>
