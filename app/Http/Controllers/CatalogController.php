...
class CatalogController extends Controller
{
    ...
    public function getShow($id){
        return view('catalog.show',array('id'=>$id),array('arrayPeliculas'=>$this->arrayPeliculas[$id]));
    }
    ...
    public function getEdit($id){
        return view('catalog.edit', array('id'=>$id),array('arrayPeliculas'=>$this->arrayPeliculas[$id]));
    }
}
